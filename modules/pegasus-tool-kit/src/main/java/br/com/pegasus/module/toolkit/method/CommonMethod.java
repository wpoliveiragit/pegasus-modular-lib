...
public final class CommonMethod {
   ...
   */
  public static Class<?> captureCreatorClass() {
  ...
  public static String timestampFormat(long timestamp) {
    DateTimeFormatter formatter = DateTimeFormatter.ofPattern(StringType.DATE_PATTERN).withZone(ZoneId.systemDefault()); // Fuso horário padrão do sistema
